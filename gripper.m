...
[returnCode,p1]=sim.simxGetJointPosition(clientID,j1,sim.simx_opmode_blocking);
[returnCode,p2]=sim.simxGetJointPosition(clientID,j1,sim.simx_opmode_blocking);
if(closing==1)
    if(p1<(p2-0.008))
